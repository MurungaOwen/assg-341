...
public class Trips {
    ...
    public static void addTrip(Trip trip) throws SQLException {
        String sql = "INSERT INTO trips(department, destination, days, description, special_request, total_students, created_at) VALUES (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)";
